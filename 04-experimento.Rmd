# Experimento da Alavanca: Estudo das Leis da Física Aplicadas ao Princípio da Alavanca
...
```{r figura-4a, attr.source="style='display:inline-block;'"}
#| fig.show: "hold"
#| out.width: "50%"
#| fig.cap: "Inicialmente, foi recortado um pedaço de papelão utilizando tesoura, que serviu como base de sustentação da montagem."
#| fig.subcap:
#|  - ""
#|  - ""

knitr::include_graphics(c("img/04/figura-4b.jpeg", "img/04/figura-4c.jpeg"))
```

2. Montagem dos suportes

```{r figura-4b}
#| fig.show: "hold"
#| fig.ncol: 2
#| out.width: "50%"
#| fig.cap: "Em seguida, foram recortados e colados dois suportes verticais de papelão sobre a base, deixando entre eles um espaço para posicionar o pincel, que funcionou como o fulcro (ponto de apoio) da alavanca. Os suportes foram colados com fita adesiva e cola, e o pincel foi perfurado e encaixado nos suportes, de modo que pudesse girar livremente."
#| fig.subcap:
#|  - ""
#|  - ""
#|  - ""

knitr::include_graphics(c("img/04/figura-4d.jpeg", "img/04/figura-4e.jpeg", "img/04/figura-4f.jpeg", "img/04/figura-4g.jpeg"))
```

3. Construção da barra da alavanca: 

```{r figura-4c}
#| fig.cap: "Foi cortado mais um pedaço retangular de papelão, que serviu como a barra da alavanca. Essa barra foi apoiada sobre o pincel, centralizada de modo que pudesse se equilibrar."

knitr::include_graphics("img/04/figura-4h.jpeg")
```
...
#| out.width: "50%"
#| fig.ncol: 2
#| fig.cap: "Em cada extremidade da barra de papelão, foi colada uma tampinha de garrafa PET. Em uma das tampinhas foram coladas duas moedas, representando um maior peso (força). Na outra tampinha foi colada apenas uma moeda, representando o menor peso."
#| fig.subcap:
#|  - ""
#|  - ""

knitr::include_graphics(c("img/04/figura-4i.jpeg", "img/04/figura-4j.jpeg"))
```

5. Observação do funcionamento

```{r figura-4e}
#| fig.cap: "A alavanca foi posicionada sobre o fulcro (pincel) e observou-se que o lado com duas moedas desceu, enquanto o lado com uma moeda subiu, demonstrando o desequilíbrio inicial. Ao mover o ponto de apoio ligeiramente em direção ao lado mais pesado, foi possível restabelecer o equilíbrio."

knitr::include_graphics("img/04/figura-4l.jpeg")
```
