...
\hypersetup{
  ...
  pdfauthor={Andressa Sabrina Rodrigues Ferreira (discente); Aron Gabriel Medeiros de Lima (discente); Antônio Denizar Marques (discente); Felipe Miguel Patchek Franco (discente); Joivana de Fátima Rodrigues Lau (discente); Sabrina Vitoria Wersel (discente); Vinicius Alady Jankovski (discente); Flaviano Williams Fernandes (docente)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Práticas experimentais para cursos de Física do ensino médio}
\author{Andressa Sabrina Rodrigues Ferreira (discente) \and Aron Gabriel Medeiros de Lima (discente) \and Antônio Denizar Marques (discente) \and Felipe Miguel Patchek Franco (discente) \and Joivana de Fátima Rodrigues Lau (discente) \and Sabrina Vitoria Wersel (discente) \and Vinicius Alady Jankovski (discente) \and Flaviano Williams Fernandes (docente)}
\date{05-12-2025}
...
\section{Autor: Antônio Denizar Marques}\label{autor-antuxf4nio-denizar-marques}
...
{\centering \subfloat[\label{fig:figura-4a-1}]{\includegraphics[width=0.5\linewidth]{img/04/figura-4b} }\subfloat[\label{fig:figura-4a-2}]{\includegraphics[width=0.5\linewidth]{img/04/figura-4c} }

}

\caption{Inicialmente, foi recortado um pedaço de papelão utilizando tesoura, que serviu como base de sustentação da montagem.}\label{fig:figura-4a}
\end{figure}
...
{\centering \subfloat[\label{fig:figura-4b-1}]{\includegraphics[width=0.5\linewidth]{img/04/figura-4d} }\subfloat[\label{fig:figura-4b-2}]{\includegraphics[width=0.5\linewidth]{img/04/figura-4e} }\newline\subfloat[\label{fig:figura-4b-3}]{\includegraphics[width=0.5\linewidth]{img/04/figura-4f} }\subfloat[\label{fig:figura-4b-4}]{\includegraphics[width=0.5\linewidth]{img/04/figura-4g} }\newline

}

\caption{Em seguida, foram recortados e colados dois suportes verticais de papelão sobre a base, deixando entre eles um espaço para posicionar o pincel, que funcionou como o fulcro (ponto de apoio) da alavanca. Os suportes foram colados com fita adesiva e cola, e o pincel foi perfurado e encaixado nos suportes, de modo que pudesse girar livremente.}\label{fig:figura-4b}
\end{figure}
...
\tightlist
\item
  Construção da barra da alavanca:
\end{enumerate}

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{img/04/figura-4h} 

}

\caption{Foi cortado mais um pedaço retangular de papelão, que serviu como a barra da alavanca. Essa barra foi apoiada sobre o pincel, centralizada de modo que pudesse se equilibrar.}\label{fig:figura-4c}
\end{figure}
...
{\centering \subfloat[\label{fig:figura-4d-1}]{\includegraphics[width=0.5\linewidth]{img/04/figura-4i} }\subfloat[\label{fig:figura-4d-2}]{\includegraphics[width=0.5\linewidth]{img/04/figura-4j} }

}

\caption{Em cada extremidade da barra de papelão, foi colada uma tampinha de garrafa PET. Em uma das tampinhas foram coladas duas moedas, representando um maior peso (força). Na outra tampinha foi colada apenas uma moeda, representando o menor peso.}\label{fig:figura-4d}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{img/04/figura-4l} 

}

\caption{A alavanca foi posicionada sobre o fulcro (pincel) e observou-se que o lado com duas moedas desceu, enquanto o lado com uma moeda subiu, demonstrando o desequilíbrio inicial. Ao mover o ponto de apoio ligeiramente em direção ao lado mais pesado, foi possível restabelecer o equilíbrio.}\label{fig:figura-4e}
\end{figure}
