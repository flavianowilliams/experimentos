...
\hypersetup{
  ...
  pdfauthor={Andressa Sabrina Rodrigues Ferreira; Aron\ldots{}; Denizar\ldots{}; Felipe Miguel Patchek Franco; Joivana de Fátima Rodrigues Lau; Sabrina Vitoria Wersel; Flaviano Williams Fernandes},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Práticas experimentais para cursos de Física do ensino médio}
\author{Andressa Sabrina Rodrigues Ferreira \and Aron\ldots{} \and Denizar\ldots{} \and Felipe Miguel Patchek Franco \and Joivana de Fátima Rodrigues Lau \and Sabrina Vitoria Wersel \and Flaviano Williams Fernandes}
\date{04-12-2025}
...
{\centering \includegraphics[width=1\linewidth]{img/01/figura-1} 
...
{\centering \includegraphics[width=1\linewidth]{img/01/figura-2} 
...
\section{Autor: Aron\ldots{}}\label{autor-aron}
...
\section{Autor: Denizar}\label{autor-denizar}
...
{\centering \includegraphics[width=1\linewidth]{img/rascunho} 
...
\chapter{Felipe Miguel Patchek Franco}\label{felipe-miguel-patchek-franco}
